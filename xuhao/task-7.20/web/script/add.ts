let dom_name:any=document.querySelector('#name'),
    dom_email:any=document.querySelector('#email'),
    dom_time:any=document.querySelector('#open_time'),
    dom_content:any=document.getElementById('content'),
    dom_tip:any=document.querySelector('#tip'),
    alerts:Nodes=document.querySelectorAll('.check'),
    dom_submit:any=document.querySelector('.submit');
...
dom_submit.addEventListener('click',function(){
    ...
    //***                 */
    .then(response => alert('Success:'+ response.id))  
